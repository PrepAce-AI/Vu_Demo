...
```text
DB_USERNAME=sa;DB_PASSWORD=mat_khau_sql;MAIL_USERNAME=email_cua_ban;app_password=ma_16_so_google;GOOGLE_CLIENT_ID=id_google;GOOGLE_CLIENT_SECRET=secret_google
